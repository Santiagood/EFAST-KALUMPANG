    ...
    <div class="space-y-6">
        ...
        <div>
            <form action="{{ route('BarangayOfficials.SendItexmo.sendSMS') }}" method="post">
                ...
                <textarea id="message" name="message" type="text" rows="10" class="block h-auto p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $selectedTemplate }}</textarea>
