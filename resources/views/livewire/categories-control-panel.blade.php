                ...
                @foreach ($allCategories as $Category)
                    <tr class="bg-white border-b text-center dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-2 py-2 md:whitespace-nowrap justify-center self-center">
                            <button wire:click='deleteShowModal({{ $Category -> id }})' type="button" class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                                {{ __('Delete') }}
                            </button>
                        </td>
                    </tr>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="w-full mx-auto my-1 mt-4">
                ...
                <x-jet-input id="category" class="block w-full mt-1" type="text" wire:model.debounce.800ms="category" required placeholder=""/>
            ...
            <div class="w-full mx-auto my-1 mt-4">
                ...
                <textarea id="category_description" wire:model="category_description" rows="4" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Category Description..."></textarea>
